def main():
    '''
    입력으로 제공되는 계좌 잔액 목록의 각 계좌 잔액에서 출금액을 출금(차감)한 뒤 각 계좌 잔액 총합을 계산하는 프로그램을 작성하시오.
     (단, 계좌잔액이 출금액보다 작으면 출금하지 않는다.)
    ...
    ####### 구현 시작 ################
    new_account = list()
    new_account = [i if i < 5000 else i - 5000 for i in accounts]
    result_accounts = sum(new_account)
