def main():
    ...
    #books = [r"Java Progamming", "Data Science", "Data-Modeling", "Programming with Data", "Python Programming"]

    search_list = []

    ####### 구현 시작 ################
    search_list = [i for i in books if i.find(keyword.title() ) != -1 or i.find(keyword) != -1 ]
    ########구현 끝 #######################
